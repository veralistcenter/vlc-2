<template>
	<main class="page pt--7">
		...
		<MatrixBody v-if='$CheckA(exhibit.bodyField.body)' :matrix="exhibit.bodyField.body" />

<!-- 		<details><pre>{{exhibit}}</pre></details> -->

		<section class="mt--4" v-if="$CheckA(exhibit.related.relatedPages)">
			<h2 class="fs--large section_heading" v-html="exhibit.related.relatedPagesTitle"></h2>
