<template>
    ...
    <button 
			...
			class="mc_nav_buttons mc_nav_previous"><img src="/previous-inline.svg" 
		/></button>

		<button 
			@click="$refs.myVueperSlides.next()" 
			class="mc_nav_buttons mc_nav_next"><img src="/next-inline.svg" 
		/></button>	
    ...
    <footer class="grid mt--1">
    	...
    	<nav class="col col--1_4 mcol--full m_order--1 right m_left col--end">
    		...
    		class="mc_nav_button_dots ml--1_2"></button>
    	</nav>
    </footer>
