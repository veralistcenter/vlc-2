  ...
  <header class="pb--2">
      ...
      <section class="col col--1_2 pb--1" v-if="single.pageFormat.pageLength">
        ...
        >
          ...
          <figcaption
            ...
            v-html="single.featImage.featuredImage.caption"
          ></figcaption>
        </figure>
      </section>
      <section
    ...
    <template v-if="single.pageFormat.pageLength">
      ...
      <aside
        role="caption"
        v-if="$Check(single.featImage.featuredImage)"
        class="section_inset mt--1_2 fs--small"
      >
...
export default {
  head() {
    ...
    return this.$metatags({
      ...
      image: this.$Check(this.single.featImage.featuredImage)
        ? this.single.featImage.featuredImage.sourceUrl
        : undefined,
